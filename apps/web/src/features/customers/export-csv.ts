...
const CSV_COLUMNS: ReadonlyArray<{
  ...
  { header: "clv_pay_probability", value: (r) => r.clv_pay_probability },
  { header: "clv_value_p10", value: (r) => r.clv_forecast_interval?.p10 ?? null },
  { header: "clv_value_p50", value: (r) => r.clv_forecast_interval?.p50 ?? null },
  { header: "clv_value_p90", value: (r) => r.clv_forecast_interval?.p90 ?? null },
