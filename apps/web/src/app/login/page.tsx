...
import { sanitizeRedirectParam, signIn } from "@/lib/auth";
...
function LoginForm() {
  ...
  const handle = async (provider: Provider) => {
    try {
      ...
      await signIn.social({ callbackURL, provider });
    } catch (e: any) {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 py-10">
      ...
      <section className="relative z-10 w-full max-w-[400px]">
        <div
          className="rounded-[32px] bg-white px-8 pt-8 pb-8"
        ...
        >
          ...
          <button
            className="mt-5 h-12 w-full rounded-2xl font-semibold text-sm text-white opacity-90"
            disabled
          ...
          <button
            className="flex h-12 w-full items-center justify-center gap-3 rounded-2xl border px-4 font-medium text-sm transition disabled:cursor-not-allowed disabled:opacity-60"
            disabled={busy !== null}
...
function GoogleIcon() {
  return (
    <svg aria-hidden="true" height="18" viewBox="0 0 48 48" width="18">
      <path
        d="M43.6 20.5H42V20H24v8h11.3c-1.6 4.7-6.1 8-11.3 8-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.8 1.1 7.9 3l5.7-5.7C34 6.1 29.3 4 24 4 13 4 4 13 4 24s9 20 20 20 20-9 20-20c0-1.3-.1-2.4-.4-3.5z"
        fill="#FFC107"
      />
      <path
      ...
      />
      <path
        d="M24 44c5.2 0 9.9-2 13.5-5.2l-6.2-5.2c-2 1.5-4.5 2.4-7.3 2.4-5.2 0-9.6-3.3-11.3-7.9l-6.5 5C9.5 39.6 16.1 44 24 44z"
        fill="#4CAF50"
      />
      <path
        d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.3-4.2 5.7l6.2 5.2C41.4 35.1 44 30 44 24c0-1.3-.1-2.4-.4-3.5z"
        fill="#1976D2"
      />
    </svg>
  );
