...
const STALE_RUN_REAPER_INTERVAL_MS = 5 * 60 * 1000;
const DEFAULT_STALE_RUN_TIMEOUT_MINUTES = 120;
const STALE_RUN_ERROR_MESSAGE = "timed out — marked failed by reaper";
...
async function reapStaleRuns(): Promise<{ prediction: number; training: number }> {
