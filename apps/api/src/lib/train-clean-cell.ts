...
export function parseCellString(value: unknown): string | null {
  // biome-ignore lint/suspicious/noEqualsToNull: value is `unknown` and can genuinely be undefined (missing Excel cell), not just null.
  if (value == null) {
    return null;
  }
  if (typeof value === "object" && value !== null && "_excel" in value) {
    ...
    if (typeof o.serial === "number") {
      return String(o.serial);
    }
  }
